        ...
        {events.slice(0, 4).map((event, index) => (
          <span
            ...
            onMouseEnter={(eventElement) => {
              eventElement.currentTarget.style.filter = "brightness(1.08)";
              eventElement.currentTarget.style.transform = "translateX(2px)";
              eventElement.currentTarget.style.boxShadow = "0 2px 7px rgba(31,41,51,.16)";
            }}
            onMouseLeave={(eventElement) => {
              eventElement.currentTarget.style.filter = "none";
              eventElement.currentTarget.style.transform = "translateX(0)";
              eventElement.currentTarget.style.boxShadow = "none";
            }}
          >
