...
import { bizzibuddiPlans } from "../data/bizzibuddiPlans";
        ...
        <div className="bizzibuddi-footer-grid" style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr 1fr", gap: 26, alignItems: "start" }}>
          ...
          <div>
            ...
            <div className="bizzibuddi-footer-account-links" style={{ display: "grid", gap: 12, fontSize: 14 }}>
              <a href="/bizzibuddi/account?view=login" style={footerLink} className="bizzibuddi-footer-link">Log in</a>
              <a href="/bizzibuddi/account?view=create" style={footerLink} className="bizzibuddi-footer-link">Start Free</a>
            </div>
          </div>
        </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, color: TEXT, fontFamily: "Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      <style>{`
        ...
        @media(max-width:850px){.bizzibuddi-desktop-nav{display:none!important}.bizzibuddi-mobile-button{display:block!important}.bizzibuddi-hero-grid{grid-template-columns:1fr!important}.bizzibuddi-three-grid,.bizzibuddi-feature-grid{grid-template-columns:1fr 1fr!important}.bizzibuddi-plan-grid{grid-template-columns:1fr 1fr!important}.bizzibuddi-final-cta{padding-top:34px!important;padding-bottom:34px!important}.bizzibuddi-final-cta h2{font-size:clamp(30px,6vw,40px)!important}.bizzibuddi-final-cta p{font-size:17px!important;margin-top:9px!important}.bizzibuddi-final-cta > div > div:last-child{margin-top:15px!important}.bizzibuddi-pricing-card{padding:15px!important}.bizzibuddi-pricing-popular{margin:-15px -15px 11px!important;padding:6px 9px!important}.bizzibuddi-pricing-price{margin-top:9px!important}.bizzibuddi-pricing-description{min-height:48px!important;margin-top:7px!important}.bizzibuddi-pricing-features{min-height:96px!important;gap:6px!important;margin-top:8px!important}.bizzibuddi-pricing-card-button{margin-top:12px!important;min-height:38px!important}.bizzibuddi-footer-grid{grid-template-columns:1fr 1fr!important}.bizzibuddi-section-pad{padding-top:34px!important;padding-bottom:34px!important}.bizzibuddi-section-pad h2{font-size:clamp(28px,6vw,38px)!important}.bizzibuddi-section-pad > div > p{font-size:14px!important;line-height:1.5!important}}
        @media(max-width:520px){.bizzibuddi-plan-grid{grid-template-columns:1fr!important;gap:9px!important}.bizzibuddi-pricing-card{padding:14px!important}.bizzibuddi-pricing-popular{margin:-14px -14px 10px!important;padding:6px 9px!important}.bizzibuddi-pricing-price{margin-top:8px!important}.bizzibuddi-pricing-description{min-height:0!important;margin-top:6px!important}.bizzibuddi-pricing-features{min-height:0!important;gap:6px!important;margin-top:8px!important}.bizzibuddi-pricing-card-button{margin-top:11px!important;min-height:38px!important}.bizzibuddi-three-grid article{padding:16px!important;min-height:0!important}.bizzibuddi-three-grid article h3{margin-top:10px!important;margin-bottom:5px!important;font-size:18px!important}.bizzibuddi-three-grid article p{font-size:12.5px!important;line-height:1.45!important}.bizzibuddi-feature-grid article{padding:15px!important;min-height:0!important}.bizzibuddi-feature-grid article h3{margin-top:8px!important;margin-bottom:5px!important;font-size:18px!important}.bizzibuddi-feature-grid article p{font-size:12.5px!important;line-height:1.45!important}.bizzibuddi-final-cta{padding-top:28px!important;padding-bottom:28px!important}.bizzibuddi-final-cta h2{font-size:clamp(28px,8vw,36px)!important}.bizzibuddi-final-cta p{font-size:15px!important;margin-top:8px!important}.bizzibuddi-final-cta > div > div:last-child{margin-top:14px!important}.bizzibuddi-final-cta button{min-height:42px!important}.bizzibuddi-footer-grid{grid-template-columns:1fr!important}.bizzibuddi-section-pad{padding-left:16px!important;padding-right:16px!important}.bizzibuddi-hero{padding:28px 16px 30px!important}.bizzibuddi-hero-logo{transform:scale(.86)}.bizzibuddi-hero-title{margin-top:12px!important;font-size:clamp(29px,8vw,38px)!important}.bizzibuddi-hero-promise{margin-top:6px!important;font-size:20px!important}.bizzibuddi-hero-copy{margin-top:8px!important;font-size:15px!important}.bizzibuddi-hero-actions{margin-top:14px!important;gap:8px!important}.bizzibuddi-hero-actions button{min-height:42px!important;padding-left:14px!important;padding-right:14px!important}.bizzibuddi-footer{padding:28px 16px 18px!important}.bizzibuddi-footer-grid{gap:18px!important}.bizzibuddi-footer-account-heading{margin-bottom:9px!important}.bizzibuddi-footer-account-links{gap:7px!important}.bizzibuddi-footer-legal{margin-top:18px!important;padding-top:11px!important;gap:9px!important}.bizzibuddi-footer-note{margin-top:10px!important}}
      `}</style>
      <header style={{ position: "sticky", top: 0, zIndex: 20, background: "rgba(6,26,43,.98)", color: "#FFF", borderBottom: `4px solid ${RED}`, backdropFilter: "blur(12px)" }}>
        <div style={{ maxWidth: 1120, margin: "0 auto", padding: "8px 22px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14 }}>
          ...
          <nav className="bizzibuddi-desktop-nav" style={{ display: "flex", alignItems: "center", gap: 15 }}>
            ...
            <a href="/bizzibuddi/account?view=login" className="bizzibuddi-nav-link" style={{ ...nav, textDecoration: "none", display: "inline-flex", alignItems: "center" }}>Log in</a>
        ...
        {mobileOpen && <div style={{ padding: "0 22px 12px", display: "grid", gap: 6 }}><button type="button" onClick={() => { setMobileOpen(false); scrollToId("why"); }} style={nav}>Why BizziBuddi</button><button type="button" onClick={() => { setMobileOpen(false); scrollToId("features"); }} style={nav}>Features</button><button type="button" onClick={() => { setMobileOpen(false); goPricing(); }} style={nav}>Pricing</button><a href="/bizzibuddi/account?view=login" onClick={() => setMobileOpen(false)} style={{ ...nav, textDecoration: "none", textAlign: "center" }}>Log in</a><CtaButton onClick={() => { setMobileOpen(false); window.location.href = "/bizzibuddi/account?view=create"; }}>Start Free →</CtaButton></div>}
      </header>
      <main>
        <section className="bizzibuddi-hero" style={{ background: `linear-gradient(135deg, ${BG} 0%, ${SURFACE} 62%, #08233A 100%)`, color: "#FFF", padding: "42px 22px 38px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
            ...
            <div className="bizzibuddi-hero-actions" style={{ marginTop: 18, display: "flex", justifyContent: "center", gap: 10, flexWrap: "wrap" }}><CtaButton onClick={() => { window.location.href = "/bizzibuddi/account?view=create"; }}>Start with BizziBuddi Free →</CtaButton><CtaButton secondary onClick={() => scrollToId("features")}>Explore BizziBuddi</CtaButton></div>
          </div>
        </section>
        ...
        <section id="features" style={{ background: "#0E1016", borderTop: `2px solid ${RED}`, borderBottom: `2px solid ${RED}`, padding: "44px 22px" }} className="bizzibuddi-section-pad"><div style={{ maxWidth: 1080, margin: "0 auto" }}><div style={sectionEyebrow}>YOUR BUSINESS. YOUR TOOLS.</div><h2 style={heading}>Six essentials.<br />One powerful BizziBuddi.</h2><div className="bizzibuddi-feature-grid" style={{ marginTop: 18, display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12 }}>{features.map(([number, title, text]) => <article key={title} className="bizzibuddi-card" style={{ ...panel, padding: 18, minHeight: 125 }}><div style={{ color: RED, fontSize: 11, fontWeight: 600, letterSpacing: 1.2 }}>{number}</div><h3 style={{ margin: "11px 0 6px", fontSize: 19 }}>{title}</h3><p style={{ margin: 0, color: "#FFFFFF", fontSize: 13, lineHeight: 1.5 }}>{text}</p></article>)}</div></div></section>
        <section id="pricing" style={{ background: "#0A0B10", padding: "44px 22px" }} className="bizzibuddi-section-pad"><div style={{ maxWidth: 1080, margin: "0 auto" }}><div style={{ textAlign: "center" }}><div style={sectionEyebrow}>SIMPLE PRICING</div><h2 style={{ ...heading, marginLeft: "auto", marginRight: "auto" }}>Start free. Grow when you're ready.</h2><p style={{ ...lead, maxWidth: 760, margin: "10px auto 0", fontSize: "clamp(16px, 1.8vw, 21px)", lineHeight: 1.35 }}>Start with the essentials. Unlock more capability as your business grows.</p></div><div className="bizzibuddi-plan-grid" style={{ marginTop: 24, display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, alignItems: "stretch" }}>{plans.map((plan) => <article key={plan.name} className="bizzibuddi-card bizzibuddi-pricing-card" style={{ ...panel, border: `2px solid ${plan.featured ? RED : "#34303A"}`, borderRadius: 14, padding: 18, display: "flex", flexDirection: "column" }}>{plan.featured && <div className="bizzibuddi-pricing-popular" style={{ margin: "-18px -18px 13px", padding: "7px 10px", background: RED, color: "#FFF", textAlign: "center", fontSize: 10, fontWeight: 600, letterSpacing: 1, textTransform: "uppercase" }}>Most popular</div>}<h3 style={{ margin: 0, fontSize: 19 }}>{plan.name}</h3><div className="bizzibuddi-pricing-price" style={{ marginTop: 11, display: "flex", alignItems: "baseline", gap: 5 }}><strong style={{ fontSize: 32 }}>{plan.price}</strong><span style={{ color: "#FFFFFF", fontSize: 11 }}>{plan.period}</span></div><p className="bizzibuddi-pricing-description" style={{ minHeight: 54, margin: "8px 0 0", color: "#FFFFFF", fontSize: 12.5, lineHeight: 1.45 }}>{plan.description}</p><div className="bizzibuddi-pricing-features" style={{ display: "grid", gap: 7, minHeight: 108, flex: 1, marginTop: 10 }}>{plan.features.map((feature) => <div key={feature} style={{ display: "flex", gap: 7, fontSize: 12.5, lineHeight: 1.35 }}><span style={{ color: RED, fontWeight: 600 }}>✓</span>{feature}</div>)}</div><button type="button" onClick={() => { window.location.href = plan.name === "Free" ? "/bizzibuddi/account?view=create" : "/bizzibuddi/account?view=plans"; }} className="bizzibuddi-cta bizzibuddi-pricing-card-button" style={{ width: "100%", marginTop: 15, minHeight: 40, border: `2px solid ${RED}`, borderRadius: 9, background: plan.featured ? RED : "transparent", color: "#FFF", fontWeight: 600, fontSize: 12.5, cursor: "pointer", transition: "background .18s ease,transform .18s ease,box-shadow .18s ease" }}>{plan.name === "Free" ? "Start Free" : `Choose ${plan.name}`}</button></article>)}</div><p style={{ textAlign: "center", margin: "14px 0 0", color: "#FFFFFF", fontSize: 11 }}>Prices shown are mock pricing for the BizziBuddi development site. Membership billing is not connected yet.</p></div></section>
        <section className="bizzibuddi-final-cta bizzibuddi-section-pad" style={{ background: `linear-gradient(135deg, ${BG} 0%, #16000A 100%)`, padding: "44px 22px" }}><div style={{ maxWidth: 1080, margin: "0 auto", textAlign: "center" }}><div style={sectionEyebrow}>READY WHEN YOU ARE</div><h2 style={heading}>A clearer way to run your business.</h2><p style={{ ...lead, marginLeft: "auto", marginRight: "auto", fontSize: "clamp(16px, 1.8vw, 21px)", lineHeight: 1.35 }}>Start with the essentials. Build from there.</p><div style={{ marginTop: 18 }}><CtaButton onClick={() => { window.location.href = "/bizzibuddi/account?view=create"; }}>Get started with BizziBuddi →</CtaButton></div></div></section>
      </main>
      <Footer />
    </div>
  );
