      ...
      <main>
        <section style={{ background: `linear-gradient(135deg, ${BG} 0%, ${SURFACE} 62%, #08233A 100%)`, color: "#FFF", padding: "76px 22px 64px" }}>
          <div style={{ maxWidth: 1080, margin: "0 auto", textAlign: "center" }}>
            ...
            <h1 style={{ margin: "28px auto 0", maxWidth: 980, fontSize: "clamp(38px, 5.4vw, 64px)", fontWeight: 700, lineHeight: 1.05, letterSpacing: -2.1 }}>Your personal assistant for business.</h1>
            <div style={{ margin: "12px auto 0", color: CYAN, fontSize: "clamp(21px, 2.6vw, 31px)", fontWeight: 700, letterSpacing: -.5 }}>Gives you time.</div>
            <p style={{ margin: "18px auto 0", maxWidth: 820, color: "#FFFFFF", fontSize: "clamp(17px, 2vw, 23px)", fontWeight: 500, lineHeight: 1.4, letterSpacing: -.2 }}>Helping you organise, plan and grow.</p>
