...
export default function BizzibuddiLandingPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, color: TEXT, fontFamily: "Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <main>
        <section style={{ background: `linear-gradient(135deg, ${BG} 0%, ${SURFACE} 62%, #08233A 100%)`, color: "#FFF", padding: "42px 22px 38px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
            <div style={{ display: "flex", justifyContent: "center" }}><BizziBuddiLogo size={96} dark showWordmark tagline="Business support, simplified." featureLine /></div>
            <h1 style={{ margin: "18px auto 0", maxWidth: 820, fontSize: "clamp(32px, 4.5vw, 52px)", fontWeight: 700, lineHeight: 1.06, letterSpacing: -1.6 }}>Your personal assistant for business.</h1>
            <div style={{ margin: "8px auto 0", color: CYAN, fontSize: "clamp(20px, 2.4vw, 28px)", fontWeight: 700, letterSpacing: -.4 }}>Gives you time.</div>
            <p style={{ margin: "10px auto 0", maxWidth: 720, color: "#FFFFFF", fontSize: "clamp(16px, 1.8vw, 20px)", fontWeight: 500, lineHeight: 1.35, letterSpacing: -.15 }}>Helping you organise, plan and grow.</p>
            <div style={{ marginTop: 18, display: "flex", justifyContent: "center", gap: 10, flexWrap: "wrap" }}><CtaButton onClick={goPricing}>Start with BizziBuddi Free →</CtaButton><CtaButton secondary onClick={() => scrollToId("features")}>Explore BizziBuddi</CtaButton></div>
          </div>
        </section>
