...
export default function CalendarPage({ clients = [], jobs = [] }) {
  ...
  function renderJobDetails(event) {
    ...
    const jobName =
      job.name || job.title || job.garmentType || job.garment || "Job";
      ...
      <div style={{ width: "100%" }}>
        ...
        >
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            <div style={{ fontSize: 17, fontWeight: 700, color: "#2F3A3F" }}>
              {jobName}
            </div>
            {job.reference && (
              <div
            ...
            {clientName && (
              <div style={{ marginTop: 3, color: "#666", fontSize: 13 }}>
                👤 {clientName}
              </div>
            )}
          </div>
      ...
      >
        ...
        {selectedEvents.length === 0 ? (
          <p style={{ color: "#999999", fontStyle: "italic" }}>
            No appointments, fittings or jobs scheduled.
          </p>
        ) : (
          selectedEvents.map((event, index) => (
            <div
              ...
              onClick={() => {
                if (
                  (event.type === "appointment" || event.type === "fitting") &&
                  event.client
                ) {
