...
export default function CalendarPage({ clients = [], jobs = [] }) {
    ...
    return (
      <div style={{ width: "100%" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
          ...
          {job.status && (
            <span style={{ background: "#E8EEF7", color: "#334E68", padding: "5px 10px", borderRadius: 999, fontSize: 12, fontWeight: 700, whiteSpace: "nowrap" }}>
              {job.status}
            </span>
          )}
        </div>
  ...
  return (
    <>
      ...
      <div ref={resultsRef} style={{ scrollMarginTop: 90, marginTop: 30, background: "#FFFFFF", border: "1px solid #DDDDDD", borderRadius: 12, padding: 20 }}>
                ...
                <>
                  ...
                  <div>
                    ...
                    <div style={{ color: "#666", fontSize: 13, marginTop: 3 }}>
                      {event.type === "fitting" ? "Fitting" : "Appointment"}
                    </div>
                  </div>
                </>
              )}
