  ...
  return (
    <aside aria-label="Buddi assistant" style={panelStyle}>
      <header style={headerStyle}>
        <div style={brandRowStyle}><BizziBuddiLogo size={42} showWordmark={false} /><div><div style={brandEyebrowStyle}>BIZZIBUDDI</div><div style={brandTitleStyle}>Your personal assistant for business</div></div></div>
