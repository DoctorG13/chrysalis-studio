  ...
  return (
    <>
      ...
      <WorkspaceSection title="Jobs" icon="💼" isOpen={openSections.jobs} onToggle={() => toggleSection("jobs")}>
        <ClientJobsPanel client={currentClient} jobs={jobs} createJob={createJob} updateJob={updateJob} deleteJob={deleteJob} initialJobId={initialJobId} />
      </WorkspaceSection>

      <WorkspaceSection title="Appointments" icon="📅" isOpen={openSections.appointments} onToggle={() => toggleSection("appointments")}>
        <AppointmentsSection clientId={currentClient.id} appointments={clientAppointments} createAppointment={createAppointment} updateAppointment={updateAppointment} deleteAppointment={deleteAppointment} />
      </WorkspaceSection>
